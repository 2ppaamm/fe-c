    ...
    angular
        ...
        .controller('AddClassCtrl', ['$scope', '$state', '$window', '$http', 'aaNotify', '$rootScope', 'auth', 'store', 'TeacherService', function ($scope, $state, $window, $http, aaNotify, $rootScope, auth, store, TeacherService) {
            ...
            $scope.addnewclass = function () {
                var course = $scope.courses;
                var classname = $scope.classname;
                var description = $scope.description;
                var startdate = $scope.cstart;
                var enddate = $scope.cend;
                TeacherService.PostCreateClass(course, classname, description, startdate, enddate).then(function () {
                    alert('Successfull create a new class !');
					store.remove('GetDashboard');
					TeacherService.GetDashboard().then(function(response){
                    ...
                    if ($scope.courses == undefined) {
                        alert('Please select a course to create class');
                    }
                    else {
                        if ($scope.classname == undefined) {
                            alert('Class name field is requried !');
                        }
                        else {
                            if ($scope.description == undefined) {
                                ...
                                if ($scope.cstart == undefined) {
                                    alert('Please insert start date !');
                                }
                                else {
                                    if ($scope.cend == undefined) {
