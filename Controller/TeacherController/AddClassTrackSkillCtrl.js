(function () {
    ...
    angular
        ...
        .controller('AddClassTrackSkillCtrl', ['$scope', '$state', '$window', '$http', 'aaNotify', '$rootScope', 'auth', 'store', 'TeacherService','$location', function ($scope, $state, $window, $http, aaNotify, $rootScope, auth, store, TeacherService,$location) {
            ...
            $scope.addnewclasstrackskill = function () {
                var sk = $scope.skillname;
                var sd = $scope.description;
                TeacherService.PostCreateTrackSkill(trackid, sk, sd).then(function () {
                    alert('Successfully add new track skill!');
					store.remove('GetDashboard');
					TeacherService.GetDashboard().then(function(response){
                    ...
                    if ($scope.skillname == undefined) {
                        alert('Skill name field is requried !');
                    }
                    else {
                        if ($scope.description == undefined) {
                            alert('Description field is requried !');
                        }
                        else {
